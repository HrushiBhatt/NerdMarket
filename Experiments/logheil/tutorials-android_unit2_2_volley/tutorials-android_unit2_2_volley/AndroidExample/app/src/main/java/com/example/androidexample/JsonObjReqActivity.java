...
public class JsonObjReqActivity extends AppCompatActivity {
    ...
    private TextView tvName, tvEmail, tvPhone, tvWebsite; // TextViews to display JSON data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvWebsite = findViewById(R.id.websiteTv);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            String website = response.getString("website"); //Extract website
